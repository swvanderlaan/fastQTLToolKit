...
DAT_loc = "/Users/Aisha/Documents/AEM_ORIGINAL_DATA/INPUT DATA/20151127_AEM_postQC7_Gohar.RData" #location of methylation data
...
ROOT_loc = "/Users/Aisha/Documents/Current Projects/mqtl"
dir.create(paste0(ROOT_loc,"/mqtl_prep"))
OUT_loc = paste0(ROOT_loc,"/mqtl_prep")
MAIN_loc = "/Users/Aisha/Documents/Current Projects/mqtl" # Location of Aisha's working directory
setwd(MAIN_loc)
...
for (i in list) { 
  assign(paste("df.AEMP.fastQTL",i,sep="_"), as.data.frame(df.AEMP.fastQTL[df.AEMP.fastQTL$"#chr" == i,]))
}
...
write.table(df.AEMP.fastQTL, paste0(OUT_loc,"/aems_plaques_450k_QC_443872.txt"), 
            quote = FALSE, sep = "\t", dec = ".", row.names = FALSE)
write.table(df.AEMB.fastQTL, paste0(OUT_loc,"/aems_blood_450k_QC_443872.txt"), 
            quote = FALSE, sep = "\t", dec = ".", row.names = FALSE)
